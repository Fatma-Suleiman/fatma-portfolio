...
const projects = [
  {
    ...
    description:
      "A comprehensive EdTech ecosystem designed to bridge the gap between students and educators. It features a streamlined interface for course management, interactive learning modules, and a responsive design that ensures education is accessible on any device.",
    image: EdunityImg,
  ...
  //   description:
  //     "A community-driven e-commerce solution designed to make essential goods more affordable and accessible.",
  //   image: KapuImg,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center">
          <a
            ...
            className="flex items-center gap-3 border-2 border-green-400
                       text-green-400 px-8 py-4 rounded-xl font-bold
